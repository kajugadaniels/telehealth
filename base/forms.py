...
class PatientForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'image': forms.FileInput(attrs={ 'class': 'form-control', 'placeholder': 'Upload your image'}),
            ...
            'id_number': forms.NumberInput(attrs={ 'class': 'form-control', 'required': 'true', 'placeholder': 'Enter your ID number'}),
            ...
            'phone_number': forms.NumberInput(attrs={ 'class': 'form-control', 'required': 'true', 'placeholder': 'Enter your phone number'}),
